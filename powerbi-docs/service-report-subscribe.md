---
title: Abonneren op Power BI-rapporten en -dashboards
...
## <a name="subscribe-to-a-dashboard"></a>Abonneren op een dashboard
![Pictogram Abonneren selecteren](media/service-report-subscribe/power-bi-subscribe-orientation.png)

1. Open het dashboard.
2. Selecteer in de bovenste menubalk **Abonneren** of selecteer het enveloppictogram ![Enveloppictogram](media/service-report-subscribe/power-bi-icon-envelope.png).
...
3. Gebruik de gele schuifregelaar om het abonnement in of uit te schakelen.  Als u schuifregelaar instelt op Uit, wordt het abonnement niet verwijderd. Selecteer het prullenbakpictogram om het abonnement te verwijderen.
   ...
   ![Venster Abonneren](media/service-report-subscribe/power-bi-subscribe-dashboard-new.png)
...
3. U kunt zich op één rapportpagina tegelijkertijd abonneren. Selecteer de desbetreffende rapportpagina in de vervolgkeuzelijst.
   ...
   ![Venster Abonnement](media/service-report-subscribe/power-bi-subscribe-dialog.png)
...
4. Gebruik de gele schuifregelaar om het abonnement voor elke pagina in of uit te schakelen.  Als u schuifregelaar instelt op Uit, wordt het abonnement niet verwijderd. Selecteer het prullenbakpictogram om het abonnement te verwijderen.
   ...
   ![Abonnement inschakelen](media/service-report-subscribe/power-bi-slider.png)
5. Selecteer **Opslaan en sluiten** om het abonnement op te slaan. U ontvangt een e-mail met een momentopname van elke rapportpagina wanneer het rapport wordt vernieuwd. Als het rapport niet wordt vernieuwd, ontvangt u die dag ook geen e-mail met een momentopname.  Als het rapport vaker dan één keer per dag wordt vernieuwd, ontvangt u alleen de eerste keer dat het dashboard wordt vernieuwd een e-mail met een momentopname.
   ...
   ![E-mail met momentopname van dashboard](media/service-report-subscribe/power-bi-subscription-email.png)
   ...
   > 
   > ![Pictogram Nu vernieuwen op tabblad Gegevenssets](media/service-report-subscribe/power-bi-refresh-now.png)
   > 
   > 

## <a name="how-the-email-schedule-for-reports-is-determined"></a>Hoe het e-mailschema voor rapporten wordt bepaald
...
* Voor verstuurde rapporten en dashboards wordt uw taalinstelling van Power BI gebruikt. De standaardtaal is Engels. Als u uw voorkeurstaal wilt bekijken of instellen, selecteert u het tandwielpictogram ![Tandwielpictogram](media/service-report-subscribe/power-bi-settings-icon.png) **> Instellingen > Algemeen > Taal**.
