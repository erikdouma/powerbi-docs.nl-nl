---
title: 'Snelstart: Power BI Pro-licenties kopen'
description: Informatie over het kopen van Power BI Pro-licenties, zodat uw gebruikers toegang hebben tot alle inhoud en mogelijkheden in de Power BI-service.
author: mgblythe
manager: kfile
ms.reviewer: ''
ms.service: powerbi
...
ms.locfileid: "34295164"
---
# <a name="quickstart-purchase-power-bi-pro-licenses"></a>Snelstart: Power BI Pro-licenties kopen
...
## <a name="purchase-power-bi-pro-licenses-through-office-365"></a>Power BI Pro-licenties kopen via Office 365
...
2. Selecteer in het linkernavigatievenster **Facturering** > **Abonnementen**.
    ...
    ![Navigatiedeelvenster](media/service-admin-purchasing-power-bi-pro/service-purchasing-power-bi-pro/service-purchasing-power-bi-pro-01.png)
