...
> 
> [!IMPORTANT]
> Power BI-beheerders kunnen de mogelijkheid om Publiceren op internet te gebruiken vanuit de beheerportal uitschakelen. Binnen **Tenantinstellingen** schakelt u **Publiceren op internet** **uit**. Dit is een tenantbrede instelling. Zie [Power BI-beheerportal](service-admin-portal.md) voor meer informatie.
> 
> 
...
2. Rapporten met Analysis Services in tabelvorm die on-premises worden gehost.
