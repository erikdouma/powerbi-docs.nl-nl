...
Als u niet de eigenaar bent van de SQL Sentry-database die wordt gesynchroniseerd naar <https://cloud.sqlsentry.com>, neemt u contact op met uw beheerder om ervoor te zorgen dat u toegang hebt tot de verzamelde gegevens.
