...
![](media/service-self-service-signup-for-power-bi/dashboard-report.png "Power BI-dashboard en rapport")
...
Als u zich wilt registreren voor Power BI, hebt u een zakelijk e-mailadres nodig. Een persoonlijk e-mailadres werkt niet bij het registreren voor Power BI.

### <a name="what-email-address-can-be-used-with-power-bi"></a>Welk e-mailadres kan worden gebruikt met Power BI?
Power BI is vereist dat u een e-mailadres van uw werk, of school, gebruikt bij de registratie. U kunt niet registreren voor Power BI met e-mailadressen die worden geleverd door e-mailservices voor consumenten of door telecomproviders. Het betreft onder andere deze e-mailadressen: outlook.com, hotmail.com en gmail.com.
...
> [!NOTE]
> U kunt registreren voor Power BI met .gov- of .mil-adressen. Lees [Uw Amerikaanse overheidsorganisatie registreren in de Power BI-service](https://docs.microsoft.com/power-bi/service-govus-signup) voor meer informatie.
>

> [!NOTE]
> Nadat u zich heb geregistreerd, kunt u [gastgebruikers uitnodigen](https://docs.microsoft.com/azure/active-directory/active-directory-b2b-what-is-azure-ad-b2b) om inhoud te bekijken in uw Power BI-tenant met een elk e-mailadres inclusief persoonlijke accounts.
>

## <a name="which-one-do-you-need"></a>Welke versie heb ik nodig?
...
## <a name="signing-up-for-power-bi-free-as-an-individual"></a>Registreren voor Power BI (gratis) als afzonderlijke gebruiker
...
> [!NOTE]
> Als een bericht wordt weergegeven dat u al geregistreerd bent, gaat u naar https://app.powerbi.com en meldt u zich aan.
> 
> 
...
### <a name="what-if-youre-already-part-of-an-existing-organization"></a>Wat gebeurt er als u al deel uitmaakt van een bestaande organisatie?
...
## <a name="what-if-you-want-the-full-power-bi-pro"></a>Wat moet ik doen om over de volledige Power BI Pro te beschikken?
