...
2. Zoek het dashboard dat u wilt verwijderen en selecteer het verwijderpictogram ![Verwijderpictogram](./media/end-user-delete/power-bi-delete-icon.png).
...
2. Zoek het rapport dat u wilt verwijderen en selecteer het verwijderpictogram   ![Verwijderpictogram](./media/end-user-delete/power-bi-delete-icon.png).   

    ![Tabblad Rapporten van een werkruimte](./media/end-user-delete/power-bi-delete-reportnew.png)
3. Bevestig de verwijdering.

   ![Dialoogvenster Rapport verwijderen](./media/end-user-delete/power-bi-delete-report.png)
...
2. Zoek de werkmap die u wilt verwijderen en selecteer het verwijderpictogram ![Verwijderpictogram](./media/end-user-delete/power-bi-delete-report2.png) .

    ![Tabblad Werkmappen](./media/end-user-delete/power-bi-delete-workbooknew.png)
3. Bevestig de verwijdering.

   ![Dialoogvenster Werkmap verwijderen](./media/end-user-delete/power-bi-delete-confirm.png)
...
2. Zoek de gegevensset die u wilt verwijderen en selecteer het beletselteken (...).  
    ...
    ![Tabblad Gegevenssets](./media/end-user-delete/power-bi-delete-datasetnew.png)
3. Selecteer in de vervolgkeuzelijst **Verwijderen**.

   ![Menu met weglatingstekens](./media/end-user-delete/power-bi-delete-datasetnew2.png)
4. Bevestig de verwijdering.

   ![Dialoogvenster Dashboard verwijderen](./media/end-user-delete/power-bi-delete-dataset-confirm.png)
...
1. Selecteer in de linker navigatie **Werkruimten**
    ...
    ![App-werkruimten](./media/end-user-delete/power-bi-delete-workspace.png)
2. Selecteer het beletselteken (...) aan de rechterkant van de werkruimte die u wilt verwijderen en kies **Werkruimte bewerken**.

   ![Menu met weglatingstekens > Werkruimte bewerken](./media/end-user-delete/power-bi-edit-workspace.png)
3. In het venster **Werkruimte bewerken** selecteert u **Werkruimte verwijderen** > **verwijderen**.

    ![Werkruimte verwijderen](./media/end-user-delete/power-bi-delete-workspace2.png)
...
2. Selecteer in de rechterbovenhoek het beletselteken (...) en kies **Werkruimte verlaten** > **Verlaten**.
      ...
      ![Werkruimte verlaten](./media/end-user-delete/power-bi-leave-workspace.png)
...
2. Houd de muis boven de app die u wilt verwijderen en selecteer het verwijderpictogram ![](./media/end-user-delete/power-bi-delete-report2.png).

   ![Apps selecteren](./media/end-user-delete/power-bi-delete-app.png)

   Als u per ongeluk een app verwijdert, hebt u verschillende opties om deze terug te zetten.  U kunt de maker van de app vragen om de app opnieuw te sturen, het oorspronkelijke e-mailbericht met de koppeling naar de app zoeken, uw [meldingencentrum](end-user-notification-center.md) controleren om te zien of er nog meldingen voor die app worden weergegeven, of de [AppSource](end-user-apps.md) van uw organisatie controleren.
...
* [Uw aanbevolen dashboard verwijderen](end-user-featured.md#change-the-featured-dashboard)
* [Een dashboard verwijderen (uit uw favorieten)](end-user-favorite.md)
* [Een rapportpagina verwijderen](end-user-delete.md)
* [Een dashboardtegel verwijderen](../service-dashboard-edit-tile.md)
* [Een visualisatie van een rapport verwijderen](end-user-delete.md)
