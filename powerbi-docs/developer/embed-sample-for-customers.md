...
Als u wilt beginnen met dit scenario, hebt u een **Power BI Pro**-account nodig. Als u geen account hebt, kunt u zich [aanmelden voor een gratis Power BI-account](../service-self-service-signup-for-power-bi.md) en zich vervolgens aanmelden voor een [Power BI Pro-proefversie](../service-self-service-signup-for-power-bi.md#in-service-power-bi-pro-60-day-trial). U kunt ook uw eigen [Azure Active Directory-tenant ](create-an-azure-active-directory-tenant.md) maken voor testdoeleinden.
...
Dit artikel bevat de code die wordt gebruikt in het [Voorbeeld voor insluiten voor uw organisatie](https://github.com/Microsoft/PowerBI-Developer-Samples/tree/master/App%20Owns%20Data) op GitHub. Als u dit scenario wilt volgen, kunt u het voorbeeld downloaden.
...
Als u het [Voorbeeld voor insluiten voor uw organisatie](https://github.com/Microsoft/PowerBI-Developer-Samples/tree/master/App%20Owns%20Data) hebt gedownload, gebruikt u de **Client-ID** die u krijgt na de registratie, zodat het voorbeeld kan verifiëren met Azure AD. Voor het configureren van het voorbeeld wijzigt u de **clientId** in het bestand *web.config*.
